...
contract TestToken is IERC20, Ownable {
     ...
     * construction.
     */
    constructor(string memory set_name, string memory set_symbol, uint8 set_decimals) {
        _name = set_name;
        _symbol = set_symbol;
        _decimals = set_decimals;
        gov = msg.sender;
        isMinter[gov] = true;
    ...
    function withdraw(uint256 amount) public {
        ...
        _burn(msg.sender, amount);
        payable(msg.sender).transfer(amount); //BLKMDF.220721
    }
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        require(msg.sender == gov, "invalid Minter");
